...
//   return (
//     <div className="overflow-hidden w-full bg-gradient-to-br from-gray-100 to-gray-200 p-20 flex flex-col items-center">
//       {/* Header Section */}
//       <header
//         className="relative h-64 md:h-72 bg-cover bg-center text-white flex flex-col items-center justify-center text-center py-20 px-16 mb-5 -mt-6 w-screen"
...
//             We're here to help you! Reach out for any queries, support, or
//             collaboration.
//           </p>
//         </motion.div>
//       </header>
...
//       {/* Main Content */}
//       <div className="w-full max-w-7xl flex flex-col md:flex-row gap-8 items-start justify-center">
//         {/* Left Info Section */}
//         <div className="w-full md:w-1/2 bg-white/60 backdrop-blur-md p-8 rounded-xl shadow-lg space-y-4">
//           <h2 className="text-3xl font-bold text-gray-700">
//             Get In <span className="text-blue-700">Touch</span>
//           </h2>
//           <p className="text-gray-600">We’re always happy to hear from you!</p>
...
//             className="w-full h-64 rounded-md border border-gray-300 mt-4"
//             allowFullScreen=""
//             loading="lazy"
//           ></iframe>
//         </div>
...
//         {/* Right Form Section */}
//         <div className="w-full md:w-1/2 bg-white/70 backdrop-blur-md rounded-xl shadow-xl p-8 md:p-10">
